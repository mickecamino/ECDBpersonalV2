...
// Main content
    ...
    echo '<div class="buttons"><div class="input"><button class="button green" name="Submit" type="submit"><span class="fas fa-user fa-lg"></span>' . _("Register") . '</button></div></div></form></div>';
